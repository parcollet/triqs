...
namespace h5 {
  ...
  static datatype str_datatype(long size) {
    ...
    if (err < 0) H5_ERROR << "Internal error in H5Tset_size";
    return dt;
  }
  ...
  void h5_write(group g, std::string const &name, std::string const &value) {
    ...
    if (err < 0) H5_ERROR << "Error writing the string named" << name << " in the group" << g.name();
  }
  ...
  void h5_write_attribute(hid_t id, std::string const &name, std::string const &value) {
    ...
    if (err < 0) H5_ERROR << "Cannot write the attribute " << name;
  }
  ...
  void h5_read(group g, std::string const &name, std::string &value) {
    ...
    if (rank != 0) H5_ERROR << "Reading a string and got rank !=0";
    ...
    if (err < 0) H5_ERROR << "Error reading the string named" << name << " in the group" << g.name();
  ...
  void h5_read_attribute(hid_t id, std::string const &name, std::string &s) {
    ...
    if (rank != 0) H5_ERROR << "Reading a string attribute and got rank !=0";
