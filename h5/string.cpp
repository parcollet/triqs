...
namespace h5 {
  ...
  template <> void io<std::string>::write(group g, std::string const &name, std::string const &value) {
  ...
  template <> void io<std::string>::write_attribute(hid_t id, std::string const &name, std::string const &value) {
  ...
  template <> void io<std::string>::read(group g, std::string const &name, std::string &value) {
  ...
  template <> void io<std::string>::read_attribute(hid_t id, std::string const &name, std::string &s) {
    s = "";
