...
namespace triqs::gfs {
  ...
  mpi_lazy<mpi::tag::reduce, block_gf_const_view<V, T, Arity>> mpi_reduce(block_gf<V, T, Arity> const &a, mpi::communicator c = {}, int root = 0,
    ...
    return {block_gf_const_view<V, T>{a}, c, root, all, op};
  }
  ...
  /**
    ...
    */
  template <typename V, typename T, int Arity, bool IsConst>
  mpi_lazy<mpi::tag::reduce, block_gf_view<V, T, Arity>> mpi_reduce(block_gf_view<V, T, Arity, IsConst> const &a, mpi::communicator c = {},
